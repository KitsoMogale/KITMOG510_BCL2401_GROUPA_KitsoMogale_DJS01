...
const d2 = newDistance(obj) //calcultes new distance
const rf = fuelRemaining(obj) //calculates remaining fuel
const vel2 = calcNewVel(obj) //calculates new velocity based on acceleration
